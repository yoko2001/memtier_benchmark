...
EXIST_REDIS_ADDR_PORT=localhost:6379
...
source $ROOT/.env/bin/activate #start env

sudo ./init_test.sh #add redis to cgroup called memtier_benchmark
...
sudo ./finish_test.sh #get cgroup info
